...
Finally, make sure your server(the program in this repo) is listening to the same port, and run the program to start receiving and parsing messages.
